export const handler = async (event) => {
  ...
  try {
    ...
    if (!response.ok) {
      return {
        statusCode: 404, // 404 Not Found: Giphy API did not return a valid response
    ...
    if (!gifDirectURL) {
      return {
        statusCode: 404, // 404 Not Found: The response from Giphy did not contain a valid GIF URL
